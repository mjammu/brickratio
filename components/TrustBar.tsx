...
export default function TrustBar() {
  ...
  return (
    ...
    >
      <span style={{ fontFamily: 'var(--font-sans), sans-serif', fontSize: 15, color: 'var(--muted)' }}>
        Advised by people from
      </span>

      <a
        href="#"
        style={{ display: 'flex', alignItems: 'center', gap: 8, opacity: 0.55, transition: 'opacity 0.2s', textDecoration: 'none', color: 'var(--text)' }}
      ...
      >
        ...
        <span style={{ fontWeight: 700, fontSize: 16 }}>Anthropic</span>
      </a>
      ...
      >
        ...
        <span style={{ fontWeight: 700, fontSize: 16 }}>OpenAI</span>
      </a>
    </div>
  )
}
